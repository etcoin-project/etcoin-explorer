...
/**
* Parse etcoin address in a string form into
...
/**
* Return string representation of etcoin address
*/
string
...
{
    // default path to etcoin folder
    // on linux this is /home/<username>/.etcoin
    string default_etcoin_dir = tools::get_default_data_dir();

    if (nettype == cryptonote::network_type::TESTNET)
        default_etcoin_dir += "/testnet";
    if (nettype == cryptonote::network_type::STAGENET)
        default_etcoin_dir += "/stagenet";


    // the default folder of the lmdb blockchain database
    // is therefore as follows
    return default_etcoin_dir + string("/lmdb");
}
